...
public class SearchPage extends JPanel {
    ...
    public SearchPage() {
        courseList = makeCourses();
        setLayout(new BorderLayout());

        searchResult = new JTextArea();
        add(searchResult,BorderLayout.CENTER);
        searchCriteria = new SearchCriteria(this);
        add(searchCriteria, BorderLayout.WEST);

    }

    public void produceSearchResults(Object subject, Object year, String average) {
    ...
    public CourseList makeCourses() {
        ...
        CourseList testDatabase = new CourseList();
